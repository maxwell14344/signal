...
import { updateAlternativePageAction } from "@/lib/actions/alternatives";
...
export function AlternativePageEditForm({ page }: { page: PageForForm }) {
  const boundAction = updateAlternativePageAction.bind(null, page.id, page.slug);
